...
public class TerminalView {
    ...
    void showInvalidSelectorError() {
        System.err.println("Invalid selector!");
    }

    void showFactorialCalcResult(int result) {
        System.out.println("factorial = " + result);
    }

    void showSquareRootCalcResult(int from, double result) {
        System.out.println("square root of " + from + ": " + result);
    }
}
